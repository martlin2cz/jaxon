...
public class J2KTransformWithHeaderVerboseImpl extends J2KTransformerWithHeader {
	...
	@Override
	protected KlaxonAbstractElement createHeaderElement(JackObject jack) throws JackToKlaxonException {
		...
		if (jack.getDescription() != null) {
			entries.add(new KlaxonElemWithValue("description", //
					jack.getDescription()));
		}
	...
	@Override
	protected String getBodyElemName(JackObject jack) throws JackToKlaxonException {
		throw new UnsupportedOperationException("Body elem is generated by transformer");
	...
	@Override
	protected void checkRoot(KlaxonAbstractElement klaxonRoot) throws JackToKlaxonException {
		...
		try {
			...
			KlaxonEntry header = klaxonRoot.asEntries().getFirst(HEADER_ELEM_NAME);
			if (header == null) {
